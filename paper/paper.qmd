...
author: 
  - Claire Ma
thanks: "Code and data are available at: [https://github.com/ClaireMa0311/Toronto-licensed-child-centers.git]."
date: today
date-format: long
...
```{r}
#| label: fig-subsidy
#| fig-cap: "Distribution of Subsidy Allocation: Disparities Exist"
#| echo: false
#| message: false
#| warning: false
...
#| fig-cap: "Subsidy Allocation by Building Type: Higher Subsidy Proportions in Public and Purpose-Built Facilities"
#| echo: false
#| message: false
#| warning: false
...
#| fig-cap: "Subsidy Allocation by Operating Auspice: Non-Profit Agencies and 'Other' Predominantly Subsidized"
#| echo: false
#| message: false
#| warning: false
...
```{r}
#| label: fig-key
#| fig-cap: "Correlation Between Total Space, Subsidy Allocation, and CWELCC Participation"
#| echo: false
#| message: false
#| warning: false
...
ggcorrplot(cor_matrix, lab = TRUE) +
  ...
  labs(
    ...
    caption = "Key Variables: Total Space, Subsidy, and CWELCC Participation"
  ) +
  theme_minimal() +
  theme(
...
```{r}
#| label: fig-cp
#| fig-cap: "Coefficient Estimates for Predictors of Subsidy Allocation"
#| echo: false
#| message: false
#| warning: false
...
```{r}
#| label: fig-roc
#| fig-cap: "ROC Curve for Model Performance: Strong Model Performance with AUC 0.906"
#| echo: false
#| message: false
#| warning: false
...
```{r}
#| label: fig-pvo
#| fig-cap: " Predicted vs. Observed Probability Plot: Model Calibration and Accuracy"
#| echo: false
#| message: false
#| warning: false
